        ...
        <div class="col-md-9 no-float">
            <div id = "main-container-messages">
                <div id="all-messages" class= "panel">
                    ...
                    if(is_array($messages))  //if is more than one appointment
                    {
                        ...
                        foreach($messages as $message)
                        {
                            ...
                            $name =  $message->getName(); //Obtain the name of the sender
                    ...
                    ?>
                            <div class="btn-group btn-group-lg btn-group-justified " id="header-messages-<?= $count ?>"
                                 send-message-to="">
                                <div class="btn-group">
                                    <button data-toggle="collapse" id="open-message" message-number="<?=$id?>" type="button" class="btn btn-default btn-primary <?=$read_message?> "
                                            data-parent="#main-container-messages" href="#messages-<?= $count ?>">
                                        <span class="glyphicon glyphicon-chevron-down"></span>
                                    </button>
                                </div>

                                <div class="btn-group"><input type="button" id="from-message-<?= $count ?>" class="btn btn-default btn-primary <?=$read_message?>" value="<?=$name?>"></div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class=" well  col-lg-12  col-md-12  col-sm-12  col-xs-12  ">
                                            <div class="text-left">
                                                <span><b>From:</b></span>
                                                <span id="edit-description-<?= $count ?>"><?=$user_id?></span>
                                                <br/>
                                            </div>
                                            <div class="text-left">
                    ...
                    <?php
                        ...
                        $id = $messages->getId();
                        $doctor_id = $messages->getDoctorId();
                        $user_id = $messages->getUserId();
                        $message_text = $messages->getText();
                        $temp =  $messages->getDateHour();
                        ...
                        <div class="btn-group btn-group-lg btn-group-justified " id="header-messages-<?= $count ?>"
                            ...
                            <div class="btn-group"><input type="button" id="from-message-<?= $count ?>"
                                                          class="btn btn-default btn-primary"
                                                          value="<?=$user_id?>"></div>
                            <div class="btn-group"><input type="button" id="subject-message-<?= $count ?>"
                                                          class="btn btn-default btn-primary"
                                                          value="<?=$subject?>"></div>
                            <div class="btn-group"><input type="button" id="date-message"
                                                          class="date btn btn-default btn-primary"
                                                          value="<?=$date?>"></div>
                            <div class="btn-group"><input type="button" id="hour-message"
                                                          class="Hour btn btn-default btn-primary"
                                                          value="<?=$hour?>"></div>
                        </div>
